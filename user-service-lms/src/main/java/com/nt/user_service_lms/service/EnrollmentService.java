...
public interface EnrollmentService {
     ...
     * @throws com.nt.user_service_lms.exception.ResourceNotFoundException if referenced entities don't exist
     * @throws com.nt.user_service_lms.exception.ResourceAlreadyExistsException if enrollment already exists and force is not enabled
     * @throws com.nt.user_service_lms.exception.ResourceNotValidException if request is invalid or enrollment fails
     */
