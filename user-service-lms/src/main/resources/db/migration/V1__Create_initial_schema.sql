...
CREATE TABLE course_content (
    course_content_id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE course_bundle (
    course_bundle_id BIGSERIAL PRIMARY KEY,
...
CREATE TABLE quiz_activity_log (
...
CREATE INDEX idx_quiz_parent_type_id ON quiz(parent_type, parent_id);
