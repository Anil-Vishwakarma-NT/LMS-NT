...
class CourseServiceImplTest {
    ...
    void testCreateCourse_Success() {
        ...
        Course created = courseService.createCourse(courseInDTO);
    ...
    void testUpdateCourse_Success() {
        ...
        String result = courseService.updateCourse(1L, courseInDTO);
    ...
    void testUpdateCourse_NotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> courseService.updateCourse(1L, courseInDTO));
    }
    ...
    void testUpdateCourse_DuplicateTitle() {
        ...
        CourseInDTO dtoWithDuplicateTitle = new CourseInDTO("New Title", 1L, "desc", "BEGINNER", "img.jpg");
