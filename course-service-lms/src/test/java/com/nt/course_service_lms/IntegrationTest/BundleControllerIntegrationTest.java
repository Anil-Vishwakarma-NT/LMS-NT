...
//    }
//
//    // Create headers with necessary authentication for tests
//    private HttpHeaders createTestHeaders() {
//        HttpHeaders headers = new HttpHeaders();
//        headers.setContentType(MediaType.APPLICATION_JSON);
//        // Add any necessary test headers here
...
//        request.setActive(true);
//
//        HttpEntity<BundleInDTO> entity = new HttpEntity<>(request, createTestHeaders());
//
//        ResponseEntity<StandardResponseOutDTO<BundleOutDTO>> response = restTemplate.exchange(
//                getBaseUrl(),
//                HttpMethod.POST,
...
//    @Order(2)
//    void shouldGetBundleById() {
//        HttpEntity<Void> entity = new HttpEntity<>(createTestHeaders());
//
//        ResponseEntity<StandardResponseOutDTO<BundleOutDTO>> response = restTemplate.exchange(
//                getBaseUrl() + "/" + createdBundleId,
//                HttpMethod.GET,
...
//        updateRequest.setActive(false);
//
//        HttpEntity<UpdateBundleInDTO> entity = new HttpEntity<>(updateRequest, createTestHeaders());
//
//        ResponseEntity<StandardResponseOutDTO<BundleOutDTO>> response = restTemplate.exchange(
//                getBaseUrl() + "/" + createdBundleId,
//                HttpMethod.PUT,
...
//    @Order(8)
//    void shouldGetExistingBundleIds() {
//        HttpEntity<List<Long>> entity = new HttpEntity<>(Arrays.asList(createdBundleId, 999999L), createTestHeaders());
//
//        ResponseEntity<List<Long>> response = restTemplate.exchange(
//                getBaseUrl() + "/existing-ids",
//                HttpMethod.POST,
...
class BundleControllerIntegrationTest {
    ...
    // Create headers for EMPLOYEE role
    ...
    // Create headers for regular USER role
    ...
    @Test
    @Order(1)
    void shouldCreateBundleWithAdminRole() {
        BundleInDTO request = new BundleInDTO();
        request.setBundleName("IntegrationBundle");
        request.setActive(true);
    ...
    void shouldDenyBundleCreationForNonAdminRole() {
        BundleInDTO request = new BundleInDTO();
        request.setBundleName("UnauthorizedBundle");
        request.setActive(true);
    ...
    @Test
    @Order(3)
    void shouldAllowAnyUserToGetBundleById() {
        // This endpoint doesn't have @PreAuthorize, so any authenticated user should access it
    ...
    @Test
    @Order(4)
    void shouldAllowAdminToGetAllBundles() {
    ...
    @Test
    @Order(5)
    void shouldDenyEmployeeFromGettingAllBundles() {
    ...
    @Test
    @Order(6)
    void shouldAllowAdminToUpdateBundle() {
        UpdateBundleInDTO updateRequest = new UpdateBundleInDTO();
        updateRequest.setBundleName("UpdatedBundleName");
        updateRequest.setActive(false);
    ...
    @Test
    @Order(7)
    void shouldDenyEmployeeFromUpdatingBundle() {
        UpdateBundleInDTO updateRequest = new UpdateBundleInDTO();
        updateRequest.setBundleName("UnauthorizedUpdate");
        updateRequest.setActive(false);
    ...
    @Test
    @Order(10)
    void shouldAllowAdminToGetBundleCount() {
        HttpEntity<Void> entity = new HttpEntity<>(createAdminHeaders());
    ...
    @Test
    @Order(11)
    void shouldDenyEmployeeFromGettingBundleCount() {
        HttpEntity<Void> entity = new HttpEntity<>(createEmployeeHeaders());
    ...
    @Order(12)
    void shouldGetExistingBundleIds() {
        HttpEntity<List<Long>> entity = new HttpEntity<>(Arrays.asList(createdBundleId, 999999L), createUserHeaders());
    ...
    @Test
    @Order(14)
    void shouldAllowOnlyAdminToDeleteBundle() {
        // Simulate admin user
        HttpEntity<Void> adminEntity = new HttpEntity<>(createAdminHeaders());
