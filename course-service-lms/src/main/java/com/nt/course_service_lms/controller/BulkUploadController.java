...
public class BulkUploadController {
    ...
    private String getCsvTemplate() {
        return "Question Text,Question Type,Options,Correct Answer,Points,Explanation,Required\n" +
                "\"What is the capital of France?\",MCQ_SINGLE,\"[\"\"Paris\"\",\"\"London\"\",\"\"Berlin\"\",\"\"Madrid\"\"]\",\"[\"\"Paris\"\"]\",1.0,\"Paris is the capital city of France.\",true\n" +
                "\"Select all prime numbers\",MCQ_MULTIPLE,\"[\"\"2\"\",\"\"3\"\",\"\"4\"\",\"\"5\"\"]\",\"[\"\"2\"\",\"\"3\"\",\"\"5\"\"]\",2.0,\"Prime numbers are 2, 3, and 5.\",true\n" +
                "\"What is 2+2?\",SHORT_ANSWER,\"[]\",\"[\"\"4\"\"]\",1.0,\"Basic arithmetic.\",false\n" +
                "\"Which programming languages are object-oriented?\",MCQ_MULTIPLE,\"[\"\"Java\"\",\"\"Python\"\",\"\"C\"\",\"\"JavaScript\"\"]\",\"[\"\"Java\"\",\"\"Python\"\",\"\"JavaScript\"\"]\",3.0,\"Java, Python, and JavaScript support OOP.\",true\n" +
                "\"What does API stand for?\",SHORT_ANSWER,\"[]\",\"[\"\"Application Programming Interface\"\"]\",1.5,\"API is a set of protocols and tools for building software applications.\",true";
    }
